...
min_width_react = 80     #in width reactangle
min_height_react = 80     #in width reactangle
...
while True:
    ...
    cv2.line(frame1,(25,count_line_positon),(1200,count_line_positon),(255,127,0),3)
    ...
    for (i,c) in enumerate(counterSahpe):
        ...
        for (x,y) in detect:
            if y<(count_line_positon+offset) and y>(count_line_positon-offset):
                counter+=1
                cv2.line(frame1,(25,count_line_positon),(1200,count_line_positon),(0,127,225),3)
                detect.remove((x,y))
